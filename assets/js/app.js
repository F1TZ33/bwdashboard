...
(function() {
  function isProductGuidePage() {
    return /product-guide\.html($|\?)/.test(window.location.href) || document.body.innerText.includes("Product Guide") && document.querySelectorAll(".productCard").length > 0;
  }

  function wireProductTileImages() {
    var fallback = "assets/img/products/_generic.png";
    ...
    imgs.forEach(function(img) {
      ...
      if (!slug) return;
      // Always try the slug file; on error, fall back to generic
...
(function(){
  ...
  function backTarget(){
    ...
    // Nested sales tips: /<repo>/sales/<tip>/index.html
